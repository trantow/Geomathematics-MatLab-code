...
This repository contains five of my most used MatLab scripts that help in processing and visualizing the mmost common data sets used in the Geomathematics Lab at CU.
